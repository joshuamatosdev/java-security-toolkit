...
### 20. Plain-language documentation

- All public docs simplified. Six words per sentence.
- Facts and warnings kept. ADRs keep their density.

### 21. Gate coverage invariant

- Every endpoint must match rules. Unmatched endpoints fail the build.

### 22. Plain repository identity
