...
/** Auto-configuration entrypoint for the layered-authorization decision core. */
@AutoConfiguration
@ConditionalOnClass(AuthorizationService.class)
@ConditionalOnProperty(
        prefix = "glyptodon.layered-authorization",
        name = "enabled",
        havingValue = "true",
        matchIfMissing = true)
@ConditionalOnMissingBean(AuthorizationService.class)
@Import(AuthorizationConfig.class)
public class LayeredAuthorizationAutoConfiguration {
}
