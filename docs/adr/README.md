...
| [0003](0003-authorization.md) | Layered authorization: typed principal, scoped policy, deny-by-default | `authorization` |
| [0004](0004-edge-dual-plane.md) | Edge perimeter: dual credential planes, deny-by-default routing | `edge` |
| [0005](0005-supply-chain-trust-horizon.md) | Supply-chain trust horizon: pin, verify, enumerate build inputs | `supply-chain` |
| [0006](0006-crypto-provider-seam.md) | Cryptographic agility: one provider seam, a registry, a reserved post-quantum slot | `crypto` |
